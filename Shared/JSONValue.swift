...
/// JSON that remains strongly Codable/Hashable while preserving Xray's long-tail
/// client settings without turning every upstream field into a Swift property.
